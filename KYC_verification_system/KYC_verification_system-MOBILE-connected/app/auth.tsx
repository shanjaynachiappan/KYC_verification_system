    ...
    try {
      if (mode === 'signup') {
        try {
          ...
          setGlobalErr(e instanceof Error ? e.message : 'Sign-up failed. Please try again.');
          Haptics.notificationAsync(Haptics.NotificationFeedbackType.Error);
          return;
        }
        ...
        // No backend auth exists by design (see earlier discussion) -- sign-in
        // is purely local, checking against the account created at sign-up.
        // It intentionally does NOT call POST /users/ again.
